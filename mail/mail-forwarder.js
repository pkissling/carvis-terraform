...
/**
 * Avoid re-forwarding forwarded mails (endless loop)
 */
exports.compareRecipients = function(data) {

  if (data.recipients && data.recipients.includes(defaultConfig.toMail)) {
    return Promise.reject(new Error("Error: Email was forwarded already. Breaking endless loop."));
  }
...
exports.transformRecipients = function(data) {
  ...
  data.recipients = [ defaultConfig.toMail ];
